(function () {
  const LS_KEYS = {
    ...
    enableDoneCooldown: 'rayitas.enableDoneCooldown',
    doneCooldownSeconds: 'rayitas.doneCooldownSeconds',
    questionCount: 'rayitas.questionCount',
    enableTts: 'rayitas.enableTts',
    ttsVoiceURI: 'rayitas.ttsVoiceURI',
